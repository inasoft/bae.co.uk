...
class AdminDashboardController extends Controller 
{
    public function getDashboardData()
    {
      ...
      return View('admin.dashboard.admin-dashboard')->with(['percentage_completed_assignment'=> $this->getonlyCompletedAssignment(),
      'percentage_only_completed_assignment'=> $this->getonlyCompletedAssignment(),
 ...
 public function getNewExpertRequest()
 {
   ...
   public function getonlyCompletedAssignment()
   {
       ...
       Session::put('completed_only_assignments_percentage', round($percOfComplAss, 2) );
