   ...
   public function addAmountInUserWallet()
   {
    ...
    public function ShowTotalAssignment($id){
        ...
        $orders=DB::table('order')
               ...
               ->where('assignment_details.uid',$id)->get();
       // dd($orders);
        if($orders)
        {
            ...
            {   
              ...
              //  dd($payment_logs_data);
                
                // print_r($payment_logs_array);
             $assignmetData=DB::table('assignment_details')->where('order_id',$order->order_id)->first();
              ...
              unset($payment_logs_array);
                 ...
                 $totalAssignments = $assignmentRequests =DB::table('users')
...
//dd($totalAssignments);
           ...
           $rewokAssignments = $assignmentRequests =DB::table('users')
                     ...
                     ->where('users.id',$id)->get();
                    // dd($rewokAssignments);
           return view('admin.dashboard.showtotal')->with(['rework_asssignment'=>$rewokAssignments,'idFormation'=>$this->idForFormation ,  'order_details'=>$orders, 'assignment_details' => $totalAssignments]);
         }   
