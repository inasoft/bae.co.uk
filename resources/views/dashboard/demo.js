...
function initApp(b6) {
 $(document).ready(authClicked(false));
    ...
    //eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE0ODIyNDE0MDcsImV4cCI6MTYzNzc2MTQwNywiYXVkIjoiMmgxajUtam9vdTJKcUFNNDIxIiwic3ViIjoidXNyOmFuaWwiLCJpZGVudGl0aWVzIjpbIm1haWw6Il19.2uHhDByvfPnvGtVY-Qjlp7stDmSbxAz-3AgPahAYeII
    ...
    function authClicked(isNewUser) {
        ...
        var get_token="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE0ODIyNDMxMDAsImV4cCI6MTYzNzc2MzEwMCwiYXVkIjoiMmgxajUtam9vdTJKcUFNNDIxIiwic3ViIjoidXNyOmRlbW8iLCJpZGVudGl0aWVzIjpbIm1haWw6Il19.OT905z6fvTG2195eCh09fKuzQOuRiAm7bu7BB3w7MbI";
        ...
        b6.session.external(get_token, function (err) {
                    ...
                    console.log(err);
                    b6.compose('usr:' + 'demo').text('Hii').send();
