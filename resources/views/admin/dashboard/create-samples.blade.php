    ...
    <div class="row">
        ...
        <div class="container app" ng-app="textAngularTest" ng-controller="wysiwygeditor">
            ...
            <div class="tag-section-head">
                ...
                <input type="text" name="title_tag" ng-model="title_tag"  placeholder="Title Tag" style="max-height: 70px;width: 50%" />
                <input type="text" name="meta_tag" ng-model="meta_tag" placeholder="Meta Tag"  style="max-height: 70px; width :50%" />
                </div>
            ...
            <div class="read-more-head">
                ...
                <input type="text" name="readContent" ng-model="read_more"  style="max-height: 120px;  height: auto;  overflow: auto;" />
            ...
            <div class="center-block mrgin_top">
                ...
                <button class="btn btn-info" ng-click="sendData(htmlcontent,read_more, htmlTopicContent, title_tag, meta_tag)" type="button">
                    Publish Data
                </button>
            </div>
...
<script type="text/javascript">
  ...
  controller('wysiwygeditor', function($scope, $http){
    ...
    $scope.title_tag='';
    $scope.meta_tag='';
    $scope.sendData=function(htmlcontent, read_more, topic, title_tag, meta_tag){
