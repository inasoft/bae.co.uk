                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    ...
                    <p style="color:#000; font-size:15px; text-align:left; font-weight:bold; font-family: Verdana, Geneva, sans-serif">	
                           Welcome , {{$value['welcome_name']}},</p>
                      <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
					  Your order has been placed successfully. We are delighted to serve you.<br><br>
					  <strong style="color:#000;">Your Order ID is :           {{$value['order_id']}} </strong><br>
					  <strong style="color:#000;">Unique Referral ID is :    {{$value['referral_code']}} </strong>
                        </p>
                       <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                             
                    <strong style="color:#000;">Offer for you: </strong> Order another assignment within 24 hours and get 50% off on another assignment.
