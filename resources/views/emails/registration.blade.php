              ...
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                  ...
                  <tr>
                    <td><table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                          ...
                          <a href="https://www.bestassignmentexperts.com/" target="_blank"><img src="http://inasoftsolutions.com/portf-project-v.4/image/logo.png" width="150" height="70" alt="" style="border-width:0; max-width:104px;height: 58px; display:block" /></a></td>
                                                  </tr>
                                                </table>
                                              </div>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    ...
                    <p style="color:#000; font-size:15px; text-align:left; font-weight:bold; font-family: Verdana, Geneva, sans-serif"> 
                           Welcome {{ucfirst($value['welcome_name'])}},</p>
                      <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                      You have registered successfully. Thank you for choosing us. We are delighted to serve you.</br></br>
                      <br>
                      <br>
            
            <strong style="color:#000;">Your Unique Referral ID is :    {{$value['referral_code']}} </strong>
                        </p>
                       <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                             
                    <strong style="color:#000;">Steps to use this code : </strong> Share this referral code with your friends. You will get $5 and $10 will be credited into your friends account once he/she complete the order.
             
                        </p>
                       <p style="color:#5b5f65; font-size:14px;font-family: Verdana, Geneva, sans-serif"">
             ...
             Team.<br/>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tbody><tr>
                    <td align="center" style="padding:40px 40px 60px 40px">                     <!-- START BUTTON -->
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                        <tbody><tr>
                                          <td width="250" height="60" align="center" bgcolor="#ff7e65" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="https://www.bestassignmentexperts.com/place-order" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">Place New Order<img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/22fbcafe-7099-4263-911a-c321c90b45de.jpg" width="32" height="17" style="padding-top:5px" alt="" border="0"></a></td>
                                        </tr>
                                      </tbody></table></td>
                                  </tr>
                                </tbody>
